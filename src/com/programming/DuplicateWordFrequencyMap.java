...
public class DuplicateWordFrequencyMap {
	...
	static void duplicatechar(String str)
	{
		...
		public static void main(String[] args) {
			DuplicateWordFrequencyMap.duplicate("I am learning java am java java");
			DuplicateWordFrequencyMap.duplicatechar("javasoftwaressolutions");
